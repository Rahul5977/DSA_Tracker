      ...
      <main>
        {!HAS_LS && (
          <div className="note-banner">
            ⚠ This environment can't save to your browser, so progress will
            reset on reload. Once you <b>build &amp; deploy this app</b> (or run
            it locally), your progress saves automatically.
          </div>
        )}
        ...
        {view === "contests" && (
          <Contests contests={state.contests} actions={actions} toast={toast} />
        )}
      </main>

      <footer>
        Built for <b>Champ!</b> · DSA cross-mapped to <b>LeetCode</b> &amp;{" "}
        <b>GeeksforGeeks</b> · CS theory: <b>OS</b> · DBMS · CN · OOP ·{" "}
        <b>Day 1 = your start date</b> · Good luck on the climb. 🏔
      </footer>
